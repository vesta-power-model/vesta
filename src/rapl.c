...
JNIEXPORT jint JNICALL Java_vesta_Rapl_ProfileInit(JNIEnv *env, jclass jcls) {
	jintArray result;
	int i;
...
JNIEXPORT jint JNICALL Java_vesta_Rapl_GetSocketNum(JNIEnv *env, jclass jcls) {
...
JNIEXPORT jstring JNICALL Java_vesta_Rapl_EnergyStatCheck(JNIEnv *env,
		jclass jcls) {
	jstring ener_string;
