...
library_extra_papi = "LD_LIBRARY_PATH=../bin/.:/usr/lib/x86_64-linux-gnu:$LD_LIBRARY_PATH"
library_path = "../bin/"
dacapo_path = "../lib/dacapo.jar:../vpc-jar-scratch/vpc.jar"
renaissance_path = "../lib/renaissance-gpl-0.14.1.jar:../vpc-jar-scratch/vpc.jar"
renaissance_jar = "../lib/renaissance-gpl-0.14.1.jar"
script_path = "../scripts/"
gc = ""
...
with open(exp_path + "/benchmarks.json") as fp:
    ...
    for test in tests:
        ...
        if probes != "none" and 0:
            ...
            output_file.write(f"python3 {script_path}java_multi_probe.py --pid $pid --probes={probes} --output_directory={exp_path}/{cluster_count}_{benchmark} & \n")
